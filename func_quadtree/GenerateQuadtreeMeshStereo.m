...
while 1 % Generate a Quadtree mesh
    [~,mark4] = funMarkEdge(coordinatesFEMQuadtree,elementsFEMQuadtree,Df_L.ImgRefMask,DICmesh.elementMinSize*2); % Don't delete "*2"
    mark4 = find(mark4);
...
[markInside4,markOutside4] = funMarkInside(coordinatesFEMQuadtree,elementsFEMQuadtree,Df_L.ImgRefMask);
...
DICmesh.coordinatesFEMWorld = [DICmesh.coordinatesFEM(:,1),DICpara.ImgSize(2)+1-DICmesh.coordinatesFEM(:,2)];

function [DICpara,x0,y0,u,v,cc]= IntegerSearch(ImgRef,ImgDef,file_name,DICpara,ImgSeqNum)
...
if (InitFFTSearchMethod == 1) || (InitFFTSearchMethod == 2)
    ...
    while InitialGuessSatisfied == 1
        ...
        fprintf('--- The size of initial guess sear chzone (pixels)? ---  \n')
        ...
        if showImgOrNot == 1
            ...
            InitialGuessSatisfied = 0; % Uncomment the above line if want to revise guess
        else
            InitialGuessSatisfied = 0; % Uncomment the above line if want to revise guess
        end
    ...
    % Uncomment the next line if want to remove bad points

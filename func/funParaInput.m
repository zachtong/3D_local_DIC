...
switch paraName
    ...
    case 'CalibrationMethod' % Calibration method
        fprintf('\n');
        fprintf('--- How do you import your calibration? --- \n');
        fprintf('    0: Matlab calibrator\n');
        fprintf('    1: MatchID format\n');
    ...
    case 'InitFFTSearchMethod' % FFT-solver to compute the initial guess
        ...
        fprintf('    3: All initial guess are zero  \n');
    ...
    case 'DataDrivenOrNot' % Data Driven mode or not
        fprintf('\n');
